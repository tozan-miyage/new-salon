    ...
    <div id="betty-page"> <a href="#" class="js-betty-nav-toggle betty-nav-toggle"><i></i></a>
        ...
        <aside id="betty-aside">
            ...
            <nav id="betty-main-menu">
                <ul>
                    <li><a href="index.html#betty-hero">Home</a></li>
        ...
        <div id="betty-main">
            <aside id="betty-hero" class="js-fullheight">
                ...
                <div class="flexslider js-fullheight">
                    <ul class="slides">
                       <li style="background-image: url(images/1920x1080.jpg);">
                                    ...
                                    <div class="col-md-12 js-fullheight slider-text">
                                        <div class="slider-text-inner">
                                            <div class="desc">
                                                ...
                                                <div class="btn btn-contact"><a href="tel:+12031230606">Call for an appointment</a></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div id="about" class="betty-about">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-6"> <img src="images/900x1000.jpg" class="img-fluid mb-30" alt=""> </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="item mb-30">
                                <div class="img"> <img src="images/200x200.jpg" alt=""> </div>
            ...
            <div id="services" class="betty-home-services betty-services">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="item">
                                <div class="position-re o-hidden"> <img src="images/600x400.jpg" alt=""> </div>
                                <div class="con">
            ...
            <!-- Testiominals -->
            <div class="betty-testimonial testimonials bg-img bg-fixed" data-background="images/1920x1080.jpg">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="owl-carousel owl-theme col-md-8">
                            <div class="item-box"> <span class="quote">
                                ...
                                <div class="info">
                                    <div class="author-img"> <img src="images/200x200.jpg" alt=""> </div>
                                    <div class="cont">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="blog-entry">
                                <a href="post.html" class="blog-img"><img src="images/600x400.jpg" class="img-fluid" alt=""></a>
                    ...
                    <div class="row">
                        <div class="col-md-12 owl-carousel owl-theme">
                            <div class="brand-logo">
                                <a href="#"><img src="images/600x300.jpg" alt=""></a>
                            </div>
                            <div class="brand-logo">
                                <a href="#"><img src="images/600x300.jpg" alt=""></a>
                            </div>
